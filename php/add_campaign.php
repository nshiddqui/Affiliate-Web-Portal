    ...
    {   
        ...
        // die();
            ...
            // video file 
             ...
             $insert=mysqli_query($con,"INSERT into campaign (campaign_name,campaign_price,campaign_desc,campaign_short_desc,campaign_img,campaign_video,campaign_link,campaign_category,campaign_sub_category) VALUES('$prd_name','$prd_price','$prd_desc','$prd_short_desc','$img','$video','$prd_link','$prd_category','$prd_sub_category')");
        if($insert){
            $_SESSION['success']="Sucessfully Add new Product";
