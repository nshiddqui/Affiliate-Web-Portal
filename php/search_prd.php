...
{   
    ...
    if($result){
        ...
        $html="<table class='table striped table_notice highlight' >
            ...
            <td data-label='campaign_desc' style='width:200px;'  >$data[campaign_desc]</td>
            ...
            <a href='../../php/activate_and_deactivate_campaign.php?d_id=$data[campaign_id] 'class='btn btn-secondary danger '>Deactivate</a></td> ";
            echo"</tr>";
            }
        $html.="</table>";
