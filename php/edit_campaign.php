...
if(isset($_POST['eid_id'])){
    ...
    $res=mysqli_query($con,"update campaign set campaign_name='$prd_name',campaign_price='$prd_price',campaign_desc='$prd_desc',campaign_short_desc='$prd_short_desc',campaign_img='$img',campaign_video='$video',campaign_link='$prd_link,campaign_category='$prd_category',campaign_sub_category'=$prd_sub_category',campaign_status='$campaign_status' where campaign_id='$campaign_id' ");
    if($res){
