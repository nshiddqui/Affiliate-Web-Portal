      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
                ...
                <i class="fas fa-edit text-white"></i>Create New Campaign</button>
                </td>
               <!-- export btn -->
               <td>
                    <button id="export" class="btn-primary right">Export Data</button>
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="prd_desc" placeholder="Product description">
        </div>
        <div class="input-group mb-3">
        ...
        <input type="submit" name="add_prd" class="btn blue" id="done_notice"value="Add Product" />
            </form>

            <!-- view product -->
            <div class="col lm-9 m9 sm-12">
                <h4>View Campaign</h4>
                <br>
        ...
        <div id="show_table_id" >
            ...
            <?php
                ...
                <a href='../../php/activate_and_deactivate_campaign.php?a_id=$data[campaign_id]' class='btn-primary'>Activate</a>

                  <a href='../../php/activate_and_deactivate_campaign.php?d_id=$data[campaign_id] 'class='btn-primary '>Deactivate</a></td> ";
                echo"</tr>";
            }
        }
        else{
